...
app = FastAPI(title="T.C. ANATOLIA-Q", version="1.5.2")
...
@app.get('/health')
async def health(): return {'status': 'online', 'system': 'T.C. ANATOLIA-Q', 'version': '1.5.2', 'provider': 'fallback-core'}
@app.post('/api/login')
