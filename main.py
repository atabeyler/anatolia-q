...
app = FastAPI(title="T.C. ANATOLIA-Q", version="1.6.4")
...
def patch_frontend(html: str) -> str:
    inject = '<script src="/chat-hotfix.js?v=1.6.4"></script><script src="/ui-tidy-hotfix.js?v=1.6.4"></script>'
    marker = "</body>"
...
@app.get("/health")
async def health():
    return {"status": "online", "system": "T.C. ANATOLIA-Q", "version": "1.6.4", "provider": "fallback-core"}
